...
def login():
    ...
    try:
        ...
        # --------------------------------------------
        return "<h2>Database Error</h2><p>An error occurred during login</p>"
...
def resource_leak():
    ...
    full_path = os.path.abspath(os.path.join(safe_dir, log_file))
...
def xxe_vulnerability():
    ...
    try:
        ...
        return "Error parsing XML: An error occurred while processing the XML data"
