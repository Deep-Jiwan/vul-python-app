...
def profile():
    ...
    return render_template_string(template, username=html.escape(username, quote=True), comment=html.escape(request.args.get('comment', 'No comment'), quote=True), password_hint=ADMIN_PASSWORD if username == 'admin' else '')
