...
def encrypt_data():
    ...
    # --------------------------------------------
    key = b'8bytekey!'  # 16 bytes for AES-128
    iv = b'1234567890123456'  # 16 bytes IV for CBC mode
...
def xxe_vulnerability():
    ...
    try:
        # --------------------------------------------
        root = ET.fromstring(xml_data, parser=ET.XMLParser(resolve_entities=False, no_network=True))
